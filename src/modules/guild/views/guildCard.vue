  ...
  methods: {
    ...
    applyAdd() {
      ...
      if (this.$state.guild.applyJoinStatus === 2) {
        Dialog({ confirmButtonColor: '#ff5c9d', confirmButtonText: '知道了', message: '您已有公会，需退出所在公会才能申请加入该公会' });
        return;
      }
