<template>
  <div class="page">
    ...
    <div class="page-ft fixed" v-if="list.length">
      <button
        class="btn btn-linear-one btn-linear-one animation anim-scalespring"
        large
        @click="toastClick"
      >
        兑换
      ...
      <p v-show="active != -999">
        兑换{{ activeText }}需<span class="color-1">{{ activeNums }}</span
        >个陪玩券，当前你有<span class="color-1">20</span
